                                    ...
                                    <form class="form-horizontal" id="cipherdata" >
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 col-form-label">
                                                <input type="text" name="name" style="width: 100%;" placeholder="please input your name" maxlength="200">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">passward :</label>
                                            <div class="col-md-9 col-form-label">
                                                <input type="password" name="passward" style="width: 100%;" placeholder="please input your passward">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">email :</label>
                                            <div class="col-md-9 col-form-label">
                                                <input type="text" name="email" style="width: 100%;" placeholder="please input your email">
                                            </div>
                                        </div>
                                        <div class="form-group row">
